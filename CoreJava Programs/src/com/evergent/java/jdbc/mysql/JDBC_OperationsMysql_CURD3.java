		...
		try{
			...
			while(flag)
			{
				...
				case 2:
					...
					break;
				case 3:
					String query11="update emp1 set ename= ? where eno =?;";
					//PreparedStatement pstmt=(PreparedStatement) con.prepareStatement(query);
					PreparedStatement pstmt11=con.prepareStatement(query11);
					System.out.println("Enter Name: ");
					String ename11=s.next();
					System.out.println("Enter Employee ID: ");
					int emp11=s.nextInt();
					pstmt11.setString(1,ename11);
					pstmt11.setInt(2,emp11);
					int i11=pstmt11.executeUpdate();
					System.out.println(i11+" row inserted");
					System.out.println("\n\n");
					break;
				case 4:
